...
const Register = () => {
    ...
    const submitHandler=(e)=>{
        ...
        myForm.append('enrollmentId', enrollmentId);
    ...
    useEffect(() => {
        document.title = "Prakalpa - Register";
  ...
  return (
    ...
    <Heading textTransform={'uppercase'} fontFamily={'mono'} children={'User Registration'} />
    ...
    <form onSubmit={submitHandler} style={{width:'100%', margin:"0" }}>
        ...
        <Box  my={'4'}>
            <FormLabel htmlFor='enrollmentId' children="University Id" />
            <Input id='enrollmentId' required placeholder='Enter your University Id' type={'text'} focusBorderColor='green.400' value={enrollmentId} onChange={(e)=>setEnrollmentId(e.target.value)}/>
        </Box>
